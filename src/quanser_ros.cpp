...
void quanser_initialize(void)
{
    ...
    hil_set_encoder_quadrature_mode(board, encoder_channels,  NUM_ENCODER_CHANNELS, quadrature_mode);
    hil_set_encoder_filter_frequency(board, encoder_channels,  NUM_ENCODER_CHANNELS, encoder_filter_frequency);
